  ...
  module Storage
    ...
    class Uploader
      ...
      def upload(filepath: nil, stream: nil, key: nil, upload_token: nil, params: {}, meta: {},
        ...
        if resumable_policy == :always || resumable_policy != :never && File.size(filepath) > Config.upload_threshold
          if filepath
          ...
          @form_uploader.sync_upload_stream(stream, key: key, upload_token: upload_token, params: params, meta: meta,
                                                    mime_type: mime_type, disable_checksum: disable_checksum,
                                                    https: https, **options)
        end
      end
